...
export const EXERCISE_LIBRARY: Exercise[] = [
  ...
  },
  {
    ...
    reps: 12,
    unit: 'reps',
    instructions: 'Lie on your back, press dumbbells over your chest until arms are straight, then lower slowly.',
    equipment: ['dumbbells'],
  },
  {
    id: 'db_goblet_squat',
    ...
    reps: 15,
    unit: 'reps',
    instructions: 'Hold one dumbbell vertically at chest height. Squat down keeping your chest up and back straight.',
    equipment: ['dumbbells'],
  },
  {
    id: 'db_lunges',
    ...
    reps: 10,
    unit: 'reps/leg',
    instructions: 'Hold dumbbells at your sides. Step forward and lower your hips until both knees are bent at 90 degrees.',
    equipment: ['dumbbells'],
  },
  {
    id: 'db_rows',
    ...
    reps: 12,
    unit: 'reps/arm',
    instructions: 'Hinge at the hips, support yourself on a bench or knee, and pull the dumbbell up to your hip.',
    equipment: ['dumbbells'],
  },
];
